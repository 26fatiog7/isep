...
public class ChoiceWall2 extends JFrame {
	...
	public ChoiceWall2(Board board, Player player,EnumWallType Wood) {
		this.setTitle("position boite en bois");
		...
		validateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				player.setWood(indexX, indexY, Wood);
				setVisible(false);
			}
		});
	}
